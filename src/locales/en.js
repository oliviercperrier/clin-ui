...
const en = {
  ...
  'components.nanuqModal.criteria.description':
    'Your selection has to follow the following criteria:',
  'components.nanuqModal.criteria.number':
    'Number: <span class="bold">maximum of 96 items</span> at a time',
  ...
  'filters.options.__missing__': 'Missing',
  'filters.options.false': 'False',
  'filters.options.true': 'True',
  ...
  'filters.options.submitted': 'Submitted',
  ...
  'form.patientSubmission.clinicalInformation.validation.cghResults':
    'Please indicate the result of the CGH',
  'form.patientSubmission.clinicalInformation.validation.clinicalSign':
    'Choose at least one clinical sign from the tree on the left in order to provide the most complete information possible on the patient to be tested.',
  'form.patientSubmission.clinicalInformation.validation.diagnosticHypothesis':
    'You must fill a diagnostic hypothesis',
  'form.patientSubmission.clinicalInformation.validation.mrn.exists':
    'The file number already exist for this hospital',
  ...
  'form.patientSubmission.form.validation.practioner':
    'Please specify the name of the referring practitioner',
  ...
  'form.patientSubmission.ramqWarning.description':
    "The patient doesn't have a RAMQ. Please edit his profile before submitting a prescription",
  'form.patientSubmission.ramqWarning.save': 'Save and quit',
  'form.patientSubmission.ramqWarning.title': 'Missing RAMQ',
  'header.description':
    'The Quebec Center for Clinical Genomics offers a high-throughput sequencing clinical platform for the molecular diagnosis of Quebec patients in partnership with the eight laboratories of the Quebec Molecular Diagnostic Network.',
  ...
  'screen.patient.creation.errors.invalidFirstName':
    'The first name should have more than 2 characters',
  'screen.patient.creation.errors.invalidLastName':
    'The last name should have more than 2 characters',
  ...
  'screen.patient.creation.success.description.fetus':
    'The fetus card has been created with success.',
  'screen.patient.creation.success.description.patient':
    'The patient card has been created with success.',
  ...
  'screen.patient.details.edit.ramq.notAvailable':
    'This RAMQ number is already assigned to another patient',
  ...
  'screen.patient.details.prescription.success.message':
    'This prescription has been successfully submitted.',
  ...
  'screen.patient.details.prescriptions.family.familyCondition':
    'Health condition(s) to a family member',
  ...
  'screen.patient.details.status.active.description':
    'This request is valid, complete, compliant, and ready to be sent to the genomic lab. Clinical information in this request will no longer be editable.',
  'screen.patient.details.status.completed': 'Completed',
  'screen.patient.details.status.completed.description':
    'This request has been completed and the data and its reports are available in the platform. Clinical information in this request will no longer be editable.',
  ...
  'screen.patient.details.status.revoked.description':
    'The request for genomic sequencing for this patient is declined. Please specify the reason here.',
  ...
  'filters.options.draft': 'Draft',
  'filters.options.incomplete': 'Incomplete',
  'filters.options.on-hold': 'On hold',
  'filters.options.revoked': 'Revoked',
  ...
  'screen.patientsearch.table.lastName': 'Name',
  ...
  'screen.patientvariant.modal.statement.draft.body':
    "You're about to create a new filter; these unsaved changes will be lost",
  ...
  'screen.patientvariant.modal.statement.duplicate.body':
    "You're about to duplicate a filter that contain unsaved changes; these unsaved changes will be transferred to the new duplicate statement",
  ...
  'querybuilder.actions.clear.description':
  ...
  'result.server.error.description':
    'An error has occured and we are not able to load content at this time.',
  'result.notfound.error.title': 'Not found',
  'result.notfound.error.description': 'Resource not found',
  'screen.patientvariant.drawer.occurrence': 'Occurrence',
  'screen.patientvariant.drawer.family': 'Family',
  ...
  'filters.group.consequences.biotype': 'Consequences Biotype',
  'filters.group.gene_external_reference': 'External Reference',
  'filters.group.genes.hpo__hpo_term_label': 'Hpo Term Label',
  'filters.group.genes.orphanet__panel': 'Orphanet Name',
  'filters.group.genes.omim__name': 'Omim Name',
  'filters.group.genes.ddd.disease_name': 'Ddd Disease Name',
  ...
  'filters.group.external_frequencies.gnomad_genomes_2_1_1__af': 'Gnomad Genomes 2.1.1',
  'filters.group.external_frequencies.gnomad_genomes_3_0__af': 'Gnomad Genomes 3.0',
  'filters.group.external_frequencies.gnomad_genomes_3_1_1__af': 'Gnomad Genomes 3.1.1',
  'filters.group.external_frequencies.gnomad_exomes_2_1_1__af': 'Gnomad Exomes 2.1.1',
  'filters.group.external_frequencies.topmed_bravo__af': 'TopMed Bravo',
  'filters.group.external_frequencies.thousand_genomes__af': '1000 Genomes',
  ...
  'filters.group.donors.filters': 'Filters',
  'filters.group.donors.qd': 'Qd',
  'filters.group.donors.ad_alt': 'Ad Alt',
  'filters.group.donors.ad_total': 'Ad Total',
  'filters.group.donors.ad_ratio': 'Ad Ratio',
  'filters.group.donors.gq': 'Gq',
};
