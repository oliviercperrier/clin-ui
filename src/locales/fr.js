const fr = {
  ...
  'screen.variantDetails.patientsTab.adAlt': 'Prof. allélique',
  'screen.variantDetails.patientsTab.adFreq': 'Prof. allélique (ratio)',
  'screen.variantDetails.patientsTab.adTotal': 'Prof. allélique (ALT+REF)',
  ...
  'screen.variantDetails.patientsTab.qd': 'Qualité de prof.',
  ...
  'screen.variant.entity.table.showtranscript': 'Afficher tous les Transcrits',
  'screen.variant.entity.table.gene': 'Gène',
  'result.server.error.title': 'Erreur du serveur',
  'result.server.error.description':
    "Une erreur s'est produite et nous ne sommes pas en mesure de charger le contenu pour le moment.",
  ...
  'screen.patientvariant.drawer.family': 'Famille',
  ...
  'filters.group.consequences.biotype': 'Conséquences Biotype',
  'filters.group.gene_external_reference': 'Référence Externe',
  'filters.group.genes.hpo__hpo_term_label': 'Étiquette de terme HPO',
  'filters.group.genes.orphanet__panel': 'Nom de l\'orphelinat',
  'filters.group.genes.omim__name': 'Nom d\'Omim',
  'filters.group.genes.ddd.disease_name': 'Nom de la maladie Ddd',
  ...
  'filters.group.external_frequencies.gnomad_genomes_2_1_1__af': 'Gnomad Génomes 2.1.1',
  'filters.group.external_frequencies.gnomad_genomes_3_0__af': 'Gnomad Génomes 3.0',
  'filters.group.external_frequencies.gnomad_genomes_3_1_1__af': 'Gnomad Génomes 3.1.1',
  ...
  'filters.group.external_frequencies.thousand_genomes__af': '1000 Génomes',
  ...
  'filters.group.donors.filters': 'Filtres',
